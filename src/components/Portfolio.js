      ...
      <section id="portfolio" className="portfolio">
        <div className="container">
          <div className="section-title">
            <h2>Portfolio</h2>
            <p>
              Our portfolio section showcases a diverse range of projects highlighting our expertise in various technologies and industries.
            </p>
          </div>
          <div className="row">
            <div className="col-lg-12 d-flex justify-content-center">
              <ul id="portfolio-flters">
                ...
                <li data-filter=".filter-flutter">Mobile App Development</li>
                <li data-filter=".filter-3d">3D Modelling</li>
                <li data-filter=".filter-web">Web Development</li>
                <li data-filter=".filter-unity">Unity</li>
                <li data-filter=".filter-data">Data Science</li>
              </ul>
            </div>
          </div>
          <div className="row portfolio-container">
            <div className="col-lg-4 col-md-6 portfolio-item filter-flutter">
